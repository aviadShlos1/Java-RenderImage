...
// ============ Equivalence Partitions Tests ==============
        ...
        List<GeoPoint> TC01result = plane.findGeoIntersectionsHelper(ray1);
        ...
        List<GeoPoint> TC02result = plane.findGeoIntersectionsHelper(ray2);
...
// =============== Boundary Values Tests ==================
        ...
        List<GeoPoint> TC03result = plane.findGeoIntersectionsHelper(ray3);
        ...
        List<GeoPoint> TC04result = plane.findGeoIntersectionsHelper(ray4);
        ...
        List<GeoPoint> TC05result = plane.findGeoIntersectionsHelper(ray5);
        ...
        List<GeoPoint> TC06result = plane.findGeoIntersectionsHelper(ray6);
        ...
        List<GeoPoint> TC07result = plane.findGeoIntersectionsHelper(ray7);
        ...
        List<GeoPoint> TC08result = plane.findGeoIntersectionsHelper(ray8);
        ...
        List<GeoPoint> TC09result = plane.findGeoIntersectionsHelper(ray9);
